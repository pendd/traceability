$(function () {
    ...
    // 用户下拉列表
    $("#matrixId").combobox({
        url : '/json/matrixRepair/getNameAndId',
        method: 'get',
        editable : true,
        valueField : 'matrixId',
        textField : 'matrixName',
    ...
    // grid初始化
    $("#tbl").datagrid({
        url : "/json/matrixRepair/getAllByPage",
        idField : "repairId",
        method : 'get',
        remoteSort:false,
        fitColumns : true,
...
function delBtnClick() {
    ...
    $.messager.confirm(lang.getText("promptNotice_prompt"), lang.getText("promptNotice_delConfirm"), function(r) {
        if (r) {
            $('#fm').form('submit', {
                url : "/json/matrixRepair/removeMatrixRepair",// 后台请求路径
...
function addRecord() {
    $("#fm").form('submit', {
        url: "/json/matrixRepair/addMatrixRepair", //后台请求路径
        onSubmit: function (param) {
...
function editRecord() {
    ...
    $('#fm').form('submit', {
        url: "/json/matrixRepair/modifyMatrixRepair",//后台请求路径
        onSubmit: function (param) {
            param.repairId = id;
