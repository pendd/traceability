...
@Mapper
@Repository
public interface XaMaterialMapper {
     ...
     */
    void updatePuArrivalVouchs(@Param("parentId")Integer parentId, @Param("childId") Integer childId, @Param("state") Integer state);
     ...
     */
    MaterialBatch selectErpMesInfoByQrCode(@Param("materialCode") String materialCode, @Param("parentId") Integer parentId, @Param("storeroomId") Integer storeroomId);
